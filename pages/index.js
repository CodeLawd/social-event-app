...
export default function Home() {
  return (
    <div>
      ...
      <div className="bg-secondary-purple h-screen flex items-center justify-center overflow-y-hidden">
        <div className="flex items-center flex-col-reverse lg:flex-row max-w-[80%] py-44 md:max-w-[60%] lg:max-w-[80%] mx-auto text-center">
          ...
          <div className="flex flex-col lg:items-end lg:justify-center lg:text-right">
            <h1 className="text-[36px] md:text-[48px] lg:text-[64px] leading-none text-primary font-bold">
              Imagine if <br />{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-purple to-primary-pink">
                Snapchat
              </span>
              <br /> had events.
            </h1>

            <p className="text-[16px] md:text-[20px] lg:text-[24px] font-light lg:w-[70%] leading-none mt-5">
              Easily host and share events with your friends across any social media.
            </p>
            <Link href="/create">
              <a className="hidden lg:block bg-gradient-to-r from-primary-purple via-purple-500 to-primary-pink rounded-lg py-3 px-14 text-[#fff] mt-10">
                🎉 Create my event
              </a>
            </Link>
          </div>
